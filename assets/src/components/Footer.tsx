    ...
    <footer className="bg-dark text-white py-5">
      <div className="container">
        ...
        <div className="text-center">
          <small>restful-booker-platform v{version} Created by <a href="http://www.mwtestconsultancy.co.uk">Mark Winteringham</a> - &copy; 2019-25 <Link href="/cookie">Cookie-Policy</Link> - <Link href="/privacy">Privacy-Policy</Link> </small>
        </div>
      </div>
    </footer>
  );
